...
def COLVAR2npy( Name, Temperature, iteration, OP_dim, Dir ='input/', Bias = False ):
    ...
    if Bias:
        traj_save_name = Dir+'x_'+Name+str(iteration)
        bias_save_name = Dir+'w_'+Name+str(iteration)
...
if __name__ == '__main__':
    ...
    for traj_index in range(n_trajs):
        COLVAR2npy.COLVAR2npy( system_name+'_%i'%traj_index, T, iteration, op_dim, 'input/', bias )
